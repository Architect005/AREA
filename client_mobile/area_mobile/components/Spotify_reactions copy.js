...
function Spotify_r(props) {
    return(
        <SafeAreaView style={{flex:1, alignItems: "center"}}>
            ...
            <View>
                <TouchableOpacity style={{marginTop: 20, width: 200, height: 120, backgroundColor: "black", borderRadius: 20, alignItems: "center", padding: 15}} onPress={() => props.navigation.navigate("Area")}>
                    <Text style={{fontWeight: "800", fontSize: 15, alignSelf: "center", color: "white", padding: 10}}>Jouer une berceuse le soir</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    )
