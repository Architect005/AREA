...
function Onedrive_r (props) {
    return (
        <SafeAreaView style={{flex:1, alignItems: "center"}}>
            ...
            <View>
                <TouchableOpacity style={{marginTop: 20, width: 200, height: 120, backgroundColor: "goldenrod", borderRadius: 20, alignItems: "center", padding: 15}} onPress={() => props.navigation.navigate("Area")}>
                    <Text style={{fontWeight: "800", fontSize: 15, alignSelf: "center", color: "#000000", padding: 15}}>Le fichier attaché est enregistré dans Onedrive</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    )
